...
void Comandos::Sair()
{
	cout << "Exibir arquivo: f arquivo" << endl;
	cout << "Append: a arquivo" << endl;
	cout << "Escrever arquivo: w arquivo" << endl;
	cout << "Listar: l" << endl;
	cout << "Abrir diretorio: c dir" << endl;
	cout << "Voltar diretorio: c ../" << endl;
	cout << "---------------------------\n" << endl;
